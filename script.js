const triangle = function () {
    ...
    if (typeof arguments[0] != "number" || typeof arguments[2] != "number") {
    ...
    if (tri.hypotenuse && tri.angle) {
        let result = solveHypotenuseAndlge(tri.hypotenuse, tri.angle);
        if (result[0] == false) return result[1];
        else return "success";
    }
...
const solveHypotenuseAndlge = function(c, beta) {
    let alpha = 90 - beta;
